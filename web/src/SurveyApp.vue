...
const inputList: Ref<Array<SurveyDetail>> = ref([
    // {
    //     content: '근무장소가 깨끗하고 쾌적하다.',
    //     category: '물리환경',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '내일은 위험하며 사고를 당할 가능성이 있다.',
    //     category: '물리환경',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '내업무는 불편한자세로 오랫동안 일을 해야한다.',
    //     category: '물리환경',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // // 직무 요구
    // {
    //     content: '나는 일이 많아 항상 시간에 쫓기며 일한다.',
    //     category: '직무요구',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '현재 하던일을 끝내기 전에 다른 일을 하도록 지시받는다.',
    //     category: '직무요구',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '업무량이 현저하게 증가하였다.',
    //     category: '직무요구',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '나는 동료나 부하직원을 돌보고 책임져야 할 부담을 안고있다.',
    //     category: '직무요구',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '내 업무는 장시간 동안 집중력이 요구된다.',
    //     category: '직무요구',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '업무수행중에 충분한 휴식(짬)이 주어진다',
    //     category: '직무요구',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '일이 많아서 직장과 가정에 다 잘하기가 힘들다.',
    //     category: '직무요구',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '여러가지 일을 동시에 해야 한다.',
    //     category: '직무요구',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // // 직무 자율
    // {
    //     content: '내 업무는 창의력을 필요로 한다.',
    //     category: '직무자율',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '업무관련 사항(업무의 일정, 업무량, 회의시간등)이 예고없이 갑작스럽게 정해지거나 바뀐다.',
    //     category: '직무자율',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '내 업무를 수행하기 위해서는 높은 수준의 기술이나 지식이 필요하다.',
    //     category: '직무자율',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '작업시간, 업무수행과정에서 나에게 결정할 권한이 주어지며 영향력을 행사할 수 있다.',
    //     category: '직무자율',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 업무량과 작업스케줄을 스스로 조절할 수 있다.',
    //     category: '직무자율',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 상사는 업무를 완료하는데 도움을 준다.',
    //     category: '관계갈등',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 동료는 업무를 완료하는데 도움을 준다.',
    //     category: '관계갈등',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '직장에서 내가 힘들때 내가 힘들다는 것을 알아주고 이해해 주는 사람이 있다.',
    //     category: '관계갈등',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '직장생활의 고충을 함께 나눌 동료가 있다.',
    //     category: '관계갈등',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '지금의 직장을 옮겨도 나에게 적합한 새로운 일을 쉽게 찾을 수 있다.',
    //     category: '직무불안정',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '현재의 직장을 그만두더라도 현재 수준만큼의 직업(직장)을 쉽게 구할수 있다.',
    //     category: '직무불안정',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '직장사정이 불안하여 미래가 불확실한다.',
    //     category: '직무불안정',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 작업은 실직하거나 해고당할 염려가 없다.',
    //     category: '직무불안정',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '앞으로 2년동안 현재의 내 직업을 잃을 가능성이 있다.',
    //     category: '직무불안정',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 근무조건이나 상황에 바람직하지 못한 변화(예:구조조정)가 있었거나 있을 것으로 예상된다.',
    //     category: '직무불안정',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '우리 직장은 근무평가,인사제도(승진,부서배치등)가 공정하고 합리적이다.',
    //     category: '조직체계',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '업무수행에 필요한 인원, 공간, 시설, 장비, 훈련, 등의 지원이 잘 이루어지고 있다.',
    //     category: '조직체계',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '우리 부서와 타 부서간에는 마찰이 없고 업무 협조가 잘 이루어진다.',
    //     category: '조직체계',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '근로자, 간부, 경영주 모두가 직장을 위해 한마음으로 일한다.',
    //     category: '조직체계',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '일에 대한 나의 생각을 반영할 수 있는 기회와 통로가 있다.',
    //     category: '조직체계',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 경력개발과 승진은 무난히 잘 될 것으로 예상한다.',
    //     category: '조직체계',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '내 현재 직위는 나의 교육 및 경력에 비추어볼때 적절하다.',
    //     category: '조직체계',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 직업은 내가 평소 기대했던 것에 미치지 못한다.',
    //     category: '보상부적절',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 모든 노력과 업적을 고려할 때 내 봉급/수입은 적절하다.',
    //     category: '보상부적절',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 모든 노력과 업적을 고려할 때, 나는 직장에서 제대로 존중과 신임을 받고 있다.',
    //     category: '보상부적절',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '나는 지금하는일에 흥미를 느낀다.',
    //     category: '보상부적절',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '내 사정이 앞으로 더 좋아질 것을 생각하면 힘든 줄 모르고 일하게 된다.',
    //     category: '보상부적절',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    // {
    //     content: '나의 능력을 개발하고 발휘할 수 있는 기회가 주어진다.',
    //     category: '보상부적절',
    //     valueList: [4, 3, 2, 1],
    //     selectInput: 0,
    // },
    ...
    // },
    // {
    //     content: '나는 기준이나 일관성이 없는 상태로 업무지시를 받는다.',
    //     category: '직장문화',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '직장의 분위기가 권위적이고 수직적이다.',
    //     category: '직장문화',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
    // {
    //     content: '남성,여성이라는 성적인 차이 때문에 불이익을 받는다.',
    //     category: '직장문화',
    //     valueList: [1, 2, 3, 4],
    //     selectInput: 0,
    // },
